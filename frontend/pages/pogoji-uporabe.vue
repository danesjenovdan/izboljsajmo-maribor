  ...
  <b-container>
    <b-row class="mt-5">
      <b-col>
        ...
        <p>
          Uporabnik lahko do storitve na spletnem naslovu: <a href="https://izboljsajmo.maribor.si/">https://izboljsajmo.maribor.si/</a>
        </p>
        <p>
        ...
        <p>
          Storitev “Izboljšajmo Maribor”, ne nadomešča upravnih postopkov, ki jih vodijo pristojni organi ali upravljavec oz. podjetje v javnem interesu in so določeni z veljavnimi zakoni.
          Upravljavec zagotavlja, da bo odgovore na pobude in vprašanja poskušal zagotoviti v največ pet delovnih dneh od prejema.
        </p>
        <p>
        ...
        <p class="my-5">
          Splošni pogoji veljajo od dneva objave.<br>
          Upravljavec storitve:<br>
