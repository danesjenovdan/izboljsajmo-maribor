...
class Initiative(Timestamped, Authored):
    ...
    location = geo_models.PointField(null=True, verbose_name=_("Lokacija"), blank=True)
    address = models.CharField(
        _("Address of initiative"), max_length=100, null=True, blank=True
    )
    ...
    def status(self):
        try:
            return (
                self.initiative_statuses.filter(publication_status=Published.PUBLISHED)
                .latest("created")
                .status.name
            )
        except:
    ...
    def status_history(self):
        ...
        if statuses:
            table_lines = "".join(
                [status.to_table_row() for status in statuses.order_by("created")]
            )
        else:
            table_lines = f"""<tr>
    ...
    def get_admin_url(self, role):
        ...
        return reverse(
            f"admin:initiatives_{type_str}initiative{role_str}_change", args=[self.id]
        )
    ...
    def get_queryset(self):
        if self.reviewer:
            return (
                ...
                .get_queryset()
                .filter(
                    type=InitiativeType.BOTHERS_ME,
                    archived=None,
                    reviewer__in=PERMISSIONS[self.reviewer],
                    is_draft=False,
                )
            )
        else:
            return (
                super()
                .get_queryset()
                .filter(type=InitiativeType.BOTHERS_ME, archived=None, is_draft=False)
            )
...
class BothersInitiativeSuper(Initiative):
    ...
    def get_admin_change_url(self):
        return reverse(
            "admin:initiatives_bothersinitiativesuper_change", args=[self.id]
        )
...
class BothersInitiativeAppraiser(Initiative):
    ...
    def get_admin_change_url(self):
        return reverse(
            "admin:initiatives_bothersinitiativeappraiser_change", args=[self.id]
        )
...
class BothersInitiativeContractor(Initiative):
    ...
    def get_admin_change_url(self):
        return reverse(
            "admin:initiatives_bothersinitiativecontractor_change", args=[self.id]
        )
    ...
    def get_queryset(self):
        if self.reviewer:
            ...
            return (
                super()
                .get_queryset()
                .filter(type=InitiativeType.HAVE_IDEA, archived=None, is_draft=False)
            )
...
class IdeaInitiativeAppraiser(Initiative):
    ...
    def get_admin_change_url(self):
        return reverse(
            "admin:initiatives_ideainitiativeappraiser_change", args=[self.id]
        )
...
class IdeaInitiativeContractor(Initiative):
    ...
    def get_admin_change_url(self):
        return reverse(
            "admin:initiatives_ideainitiativecontractor_change", args=[self.id]
        )
    ...
    def get_queryset(self):
        if self.reviewer:
            return (
                ...
                .get_queryset()
                .filter(
                    type=InitiativeType.INTERESTED_IN,
                    archived=None,
                    reviewer__in=PERMISSIONS[self.reviewer],
                    is_draft=False,
                )
            ...
            return (
                ...
                .get_queryset()
                .filter(
                    type=InitiativeType.INTERESTED_IN, archived=None, is_draft=False
                )
            )
...
class InterestedInitiativeSuper(Initiative):
    ...
    def get_admin_change_url(self):
        return reverse(
            "admin:initiatives_interestedinitiativesuper_change", args=[self.id]
        )
...
class InterestedInitiativeArea(Initiative):
    ...
    def get_admin_change_url(self):
        return reverse(
            "admin:initiatives_interestedinitiativearea_change", args=[self.id]
        )
...
class InterestedInitiativeAppraiser(Initiative):
    ...
    def get_admin_change_url(self):
        return reverse(
            "admin:initiatives_interestedinitiativeappraiser_change", args=[self.id]
        )
