...
from initiatives.models import Initiative, Rejection, Reviwers
from initiatives.serializers import RejectionSerializer
from rest_framework import authentication, mixins, permissions, views, viewsets
...
class RejectionViewSet(viewsets.GenericViewSet, mixins.RetrieveModelMixin):
    permission_classes = []
